export enum PageType {
  ...
  HonorsAndQualifications = 'honors-and-qualifications',
...
export const PageNameMap: Record<PageType, {
  ...
  [PageType.NewsAndInformation]: { cnName: '新闻与信息', enName: 'News and Information' },
  [PageType.HonorsAndQualifications]: { cnName: '荣誉与资质', enName: 'Honors and Qualifications' },
  [PageType.OnlineSupport]: { cnName: '在线支持', enName: 'Online Support' },
  [PageType.OnlineService]: { cnName: '在线服务', enName: 'Online Service' },
  [PageType.Partnership]: { cnName: '合作伙伴', enName: 'Partnership' },
  [PageType.Resources]: { cnName: '资源', enName: 'Resources' },
...
export const BannerPages = [
  ...
  PageType.About,
  PageType.Careers,
  PageType.NewsAndInformation,
  PageType.HonorsAndQualifications,
